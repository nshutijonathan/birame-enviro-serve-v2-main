    ...
    <div id="about" className='mt-[10rem]'>
      ...
      <div className="relative">
        <img
          ...
          alt="image not found"
          className="md:w-full   md:object-cover h-[35rem] "
        />
          ...
          <div className="mt-1 lg:mt-12">
            <Fade direction="up">
              <div className="my-5 md:my-[20px]">
                <h1 className="text-center text-white font-semibold text-[1.5rem] md:my-[20px]">
                  Our Story
                </h1>

                <p className="text-center text-white text-[1.1rem] flex md:hidden mx-4">
                ...
                <p className="text-center text-white text-[1.1rem] font-bold hidden md:flex">
                  We are a Rwandan NGO founded by a group of young professionals
            ...
            <Fade direction="up">
              <div className="my-5 md:my-[20px]">
                ...
                <p className="text-center text-white text-[1.1rem] flex md:hidden">
            ...
            <Fade direction="up">
              <div className="my-5 md:my-[20px]">
                ...
                <p className="text-center text-white text-[1.1rem] px-4 md:px-0 flex md:hidden">
