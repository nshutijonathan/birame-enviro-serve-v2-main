...
const About = () => {
  return (
    <div id="about" className='mt-[10rem]'>
          <h1 className='font-sora text-gray-600 font-semibold text-[1.5rem] text-center my-12'>ABOUT US</h1>
      <div className="relative">
        <img
          src="../ProjectsFiles/bird-rwandan1.jpeg"
          alt="image not found"
          className="md:w-full    md:object-cover bg-green-400 h-[35rem] xl:h-[60rem]  "
        />
        ...
        <div className="flex w-full absolute top-0 z-10 justify-center md:px-[100px]">
          <div className="mt-1 lg:mt-[12rem] xl:mt-[23rem]">
            <Fade direction="up">
              <div className="my-5 md:my-[20px]">
                <h1 className="text-center text-white font-semibold text-[1.5rem] xl:text-[1.6rem] md:my-[20px]">
                  Our Story
                </h1>

                <p className="text-center text-white text-[1.1rem] xl:text-[1.6rem] flex md:hidden mx-4">
                ...
                <p className="text-center text-white text-[1.1rem] xl:text-[1.6rem] font-bold hidden md:flex">
                  We are a Rwandan NGO founded by a group of young professionals
            ...
            <Fade direction="up">
              <div className="my-5 md:my-[20px]">
                <h1 className="text-center text-white font-semibold xl:text-[1.6rem] text-[1.5rem] md:my-[20px]">
                  OUR MISSION
                </h1>
                <p className="text-center text-white text-[1.1rem] xl:text-[1.6rem] flex md:hidden">
            ...
            <Fade direction="up">
              <div className="my-5 md:my-[20px]">
                ...
                <p className="text-center text-white text-[1.1rem] xl:text-[1.6rem] px-4 md:px-0 flex md:hidden">
                  Biodiversity within natural and human-altered landscapes in
                  rural and urban 
                  areas is well conserved and derived ecosystem services are
                  flourishing.
                </p>
                <p className="text-center text-white xl:text-[1.6rem] text-[1.1rem] font-bold hidden md:flex">
                  Biodiversity within natural and human-altered landscapes in
                  rural and urban <br />
                  areas is well conserved and derived ecosystem services are
                  flourishing.
